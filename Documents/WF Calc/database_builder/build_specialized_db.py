...
def build_database(db_file, files_to_parse):
...
if __name__ == '__main__':
    # Build arch_weapons.db
    build_database('arch_weapons.db', [
        ('Arch-Gun.json', 'Arch-Gun'),
        ('Arch-Melee.json', 'Arch-Melee')
    ])
    
    # Build companion_weapons.db
    build_database('companion_weapons.db', [
        ('SentinelWeapons.json', 'Companion-Weapon')
    ])
